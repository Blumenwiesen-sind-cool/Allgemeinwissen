...
function showResult() {
    ...
    if (userScore >= 9) { // if user scored 9 or 10
        ...
        scoreTag = '<span>Gut gemacht! 👍 Du hast <p>' + userScore + '</p> von <p>' + questions.length + '</p> richtig beantwortet. Weiter so!</span>';
...
function queCounter(index) {
    ...
    let totalQueCounTag = '<span> Frage <p>' + index + '</p> von <p>' + questions.length + '</span>';
